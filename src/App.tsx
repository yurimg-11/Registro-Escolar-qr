...
export default function App() {
  ...
  useEffect(() => {
    // Check if user was already logged in as student
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="text-left">
              <h3 className="text-lg font-bold text-slate-900">Soy Alumno</h3>
          ...
          >
            ...
            <div className="text-left">
              <h3 className="text-lg font-bold text-slate-900">Personal Escolar</h3>
